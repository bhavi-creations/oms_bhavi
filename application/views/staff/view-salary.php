                  ...
                  if (isset($content)):
                    ...
                    foreach ($content as $cnt):
                      ...
                      <tr>
                        ...
                        <td><a href="<?php echo base_url(); ?>staff-salary-invoice/<?php echo $cnt['id']; ?>"
                            class="btn btn-warning">Invioce</a></td>
                        <td><img src="<?php echo base_url(); ?>uploads/staff-files/<?php echo $cnt['payslip'] ?>"
                            width="50px" alt="Payslip"></td>
                      </tr>
                      <?php
                      $i++;
                    endforeach;
