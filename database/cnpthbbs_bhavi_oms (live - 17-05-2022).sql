...
(109, 14, '2022-05-17 19:00:10', NULL, '175.101.26.36', 1),
(110, 1, '2022-05-17 20:31:04', NULL, '175.101.26.36', 1);
...
(17, 15, 2400, 0, 2400, 1, '0000-00-00', '2022-05-10 04:33:27');
...
(10, '20', '0', 14, 'Projects multiple files upload,\r\nStaff multiple files upload,\r\nsome bug fixes.\r\n', 'completed', '2022-05-09', 0),
(11, '3', '0', 14, 'SEO Changes,\r\nadmin@bhavicreations.com email from text to image changed according to SEOptimzer', 'completed', '2022-05-09', 0),
(12, '20', '0', 14, 'Select Dropdowns with Search in all Modules ( 1 Day )', 'completed', '2022-05-10', 0),
(13, '3', '0', 14, '1. CSS & JS minify, Inline with litespeed plugin\r\n2. checked image alt attributes - didnt find the image that is showing in report (cant able to change)\r\n3. font size - send message popup font size change', 'completed', '2022-05-11', 0),
(14, '4', '0', 14, '1. Seemless image change\r\n2. JCI service section removed\r\n3. Services Image changes\r\n4. copyright link changes', 'completed', '2022-05-11', 0),
(15, '3', '0', 14, 'Checked to remove unwanted text in header\r\nwhich is coming by google tag manager\r\nNOT SOlVED', 'pending', '2022-05-12', 0),
(16, '5', '0', 14, 'Changes\r\n1. Header links changes to - Home,about,services,customer login, franchise login,contact \r\n2. Services we offer links to bhavicreations.com\r\n3. 2499 to 6999 price change in web developement service\r\n4. social links added - content took from bhavicreations\r\n5. copyright link to bhavicreations.com', 'completed', '2022-05-12', 0),
(17, '20', '20', 14, 'Date filter & export records started.', 'inprogress', '2022-05-12', 0),
(18, '20', '20', 14, 'Filters & Export Options for Records\r\nwork is in progress', 'inprogress', '2022-05-14', 0),
(19, '0', '0', 14, 'Filters based on Date and Staff Name Added', 'completed', '2022-05-16', 0),
(20, '0', '0', 14, 'Bhavi Online management system\r\nproject tasks daily tasks & priority added', 'completed', '2022-05-17', 0);
